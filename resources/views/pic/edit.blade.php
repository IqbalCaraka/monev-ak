        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="card-title mb-1">Edit PIC DMS</h4>
                        <p class="text-muted mb-0">Perbarui data PIC DMS</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select @error('ketua_nip') is-invalid @enderror"
                            ...
                            @foreach($pegawai as $p)
                                <option value="{{ $p->nip }}" {{ old('ketua_nip', $pic->ketua_nip) == $p->nip ? 'selected' : '' }}>
                                    {{ $p->nama }} ({{ $p->nip }})
                                </option>
                            @endforeach
                        </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                                    ...
                                    <div id="anggotaList" style="padding-left: 5px;">
                                        @php
                                            $selectedAnggota = old('anggota_nip', $pic->anggota->pluck('nip')->toArray());
                                        @endphp
                                        @foreach($pegawai as $p)
                                            <div class="form-check anggota-item" style="padding-left: 1.5rem;">
                                                <input class="form-check-input"
                                                       ...
                                                       value="{{ $p->nip }}"
                                                       id="anggota_{{ $p->nip }}"
                                                       {{ in_array($p->nip, $selectedAnggota) ? 'checked' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                                    ...
                                    <div id="instansiList" style="padding-left: 5px;">
                                        @php
                                            $selectedInstansi = old('instansi_id', $pic->instansi->pluck('id')->toArray());
                                        @endphp
                                        @foreach($instansi as $inst)
                                            <div class="form-check instansi-item" style="padding-left: 1.5rem;">
                                                <input class="form-check-input"
                                                       ...
                                                       {{ in_array($inst->id, $selectedInstansi) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3" style="padding-left: 5px;">
                        <div class="form-check form-switch" style="padding-left: 2.5rem;">
                            <input class="form-check-input"
                                   ...
                                   name="is_active"
                                   value="1"
                                   {{ old('is_active', $pic->is_active) ? 'checked' : '' }}>
